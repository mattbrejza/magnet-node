...
static void cmd_esp(BaseSequentialStream *chp, int argc, char *argv[])
{
    ...
    else if(strcmp(argv[0], "ver") == 0)
    {
        ...
        esp_request(ESP_MSG_VERSION, NULL, 1, chVTGetSystemTime(),
                ESP_PRIO_NORMAL);
    } /* argv[0] is ver */
    else if(strcmp(argv[0], "reset") == 0)
    {
        /* Ask to reset ESP */
        esp_request(ESP_MSG_RST, NULL, 1, chVTGetSystemTime(),
                ESP_PRIO_NORMAL);
    } /* argv[0] is reset */
    ...
    else if(strcmp(argv[0], "ap") == 0)
    {
        if(argc == 3)
        {
            ...
            *tbuf_ptr++ = '\0';
            ...
            esp_request(ESP_MSG_JOIN, &packet, 1, chVTGetSystemTime(),
                    ESP_PRIO_NORMAL);
        } 
        else if(argc == 1)
        {
    ...
    else if(strcmp(argv[0], "testhttp") == 0)
    {
        ...
        esp_request(ESP_MSG_START, &packet, 1, chVTGetSystemTime(),
                ESP_PRIO_NORMAL);
    }
